...
const CardVistaCapacitacion = ({ data }) => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-6">
      <button className="bg-white text-primario_2 border border-primario_2 rounded-xl px-6 py-2 font-medium shadow hover:bg-primario_2 hover:text-white hover:scale-105 transition-all">
